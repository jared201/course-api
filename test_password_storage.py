#!/usr/bin/env python3
"""
Test script to verify that passwords are being saved in Redis.
...
Example:
   python test_password_storage.py
"""
import asyncio
import os
...
async def test_password_storage():
    """Test that passwords are being saved in Redis."""
    try:
        ...
        print("Creating a test user with password...")
        user_data = {
            "username": "testuser",
        ...
        # Verify that the password is stored in Redis
...
if __name__ == "__main__":
    try:
        asyncio.run(test_password_storage())
